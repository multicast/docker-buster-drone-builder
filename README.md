...
# Packages
    ...
    ii  docker-ce                     5:20.10.4~3-0~debian-buster amd64        Docker: the open-source application container engine
    ii  docker-ce-cli                 5:20.10.4~3-0~debian-buster amd64        Docker CLI: the open-source application container engine
