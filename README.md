...
# Packages
    ...
    ii  docker-ce                     5:24.0.0-1~debian.10~buster amd64        Docker: the open-source application container engine
    ii  docker-ce-cli                 5:24.0.0-1~debian.10~buster amd64        Docker CLI: the open-source application container engine
