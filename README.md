...
# Packages
    ...
    ii  ghostscript                   9.27~dfsg-2+deb10u3          amd64        interpreter for the PostScript language and for PDF
    ...
    ii  libgs9:amd64                  9.27~dfsg-2+deb10u3          amd64        interpreter for the PostScript language and for PDF - Library
    ii  libgs9-common                 9.27~dfsg-2+deb10u3          all          interpreter for the PostScript language and for PDF - common files
