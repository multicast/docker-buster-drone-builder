...
# Packages
    ...
    ii  containerd.io                 1.6.32-1                      amd64        An open and reliable container runtime
    ...
    ii  docker-ce                     5:26.1.3-1~debian.10~buster   amd64        Docker: the open-source application container engine
    ii  docker-ce-cli                 5:26.1.3-1~debian.10~buster   amd64        Docker CLI: the open-source application container engine
    ...
    ii  python3-idna                  2.6-1+deb10u1                 all          Python IDNA2008 (RFC 5891) handling (Python 3)
