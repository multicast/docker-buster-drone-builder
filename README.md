...
# Packages
    ...
    ii  docker-ce                     5:24.0.2-1~debian.10~buster   amd64        Docker: the open-source application container engine
    ii  docker-ce-cli                 5:24.0.2-1~debian.10~buster   amd64        Docker CLI: the open-source application container engine
    ...
    ii  libcups2:amd64                2.2.10-6+deb10u7              amd64        Common UNIX Printing System(tm) - Core library
    ii  libcupsimage2:amd64           2.2.10-6+deb10u7              amd64        Common UNIX Printing System(tm) - Raster image library
    ...
    ii  linux-libc-dev:amd64          4.19.282-1                    amd64        Linux support headers for userspace development
